-- 28_final_view_fix.sql

-- ========================================================
-- 1. حذف العرض القديم لتمكين تغيير أسماء الأعمدة
-- ========================================================
DROP VIEW IF EXISTS delivery_bags_report_view;

-- ========================================================
-- 2. إعادة إنشاء العرض بالمنطق الجديد وأسماء الأعمدة الجديدة
-- ========================================================
...
SELECT 
    ...
    -- المنطق الجديد لعرض اسم الموصل أو حالة المخزن
    CASE 
...
-- ========================================================
-- 3. مزامنة البيانات (نسخة مصححة ومجربة)
-- ========================================================
DO $$ 
DECLARE r RECORD;
BEGIN
